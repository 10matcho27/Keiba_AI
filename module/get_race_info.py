...
def get_race_info(race_date: str):
    ...
    try:
        ...
        race_info = {}
        fieldname = ["race_ids", "race_urls", "race_date"]
        ...
        for a_tag in soup.select('.RaceList_DataItem > a:first-of-type'):
            ...
            race_info["race_ids"].append(race_id)
            race_info["race_urls"].append(result_url_template.format(race_id = race_id))
            race_info['race_date'].append(race_date)
    # finally:
        driver.close()
        # driver.quit()
    except:
        ...
        fieldname, race_info = get_race_info(race_date)
    # return race_ids, race_urls
    return fieldname, race_info

if __name__ == '__main__':
    race_ids = get_race_info('')
    print(race_ids)